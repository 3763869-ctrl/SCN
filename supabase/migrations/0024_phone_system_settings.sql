create table if not exists public.phone_system_settings (
  ...
  working_hours_greeting text not null default 'Thank you for calling S C N. Please enter the worker extension you are trying to reach.',
  after_hours_greeting text not null default 'Thank you for calling S C N. We are currently closed. Please leave a message and we will call you back at the first opportunity.',
