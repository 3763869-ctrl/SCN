...
export async function getPartnerOperationsData() {
  ...
  const partnerSelect =
    "id, client_id, full_name, email, phone, address_line1, address_line2, city, state, country, zip_code, bank_name, bank_account_holder_name, bank_account_number, bank_routing_number, zelle_payment_info, invoice_notes, status, start_date, notes, list_order";
